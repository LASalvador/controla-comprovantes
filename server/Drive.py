...
class Drive:
    ...
    def mkdir(self, dir_name):
        ...
        folder = __service.files().create(body=file_metadata,
                                        fields='id').execute()
    ...
    def getFolderId(self, dir_name):
        dirs = __service.files().list(q="mimeType='application/vnd.google-apps.folder'", fields='files(id, name)').execute()
